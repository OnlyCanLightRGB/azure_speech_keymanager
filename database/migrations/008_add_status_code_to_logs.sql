...
-- Check and add columns to key_logs table
...
-- Check and add columns to translation_key_logs table
...
-- Update action column to use ENUM for better consistency (only if needed)
ALTER TABLE `key_logs` 
